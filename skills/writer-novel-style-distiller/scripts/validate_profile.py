    ...
    if not errors:
        ...
        if humor_heading in style_text:
            if not (
                ...
                errors.append("references/style-profile.md: humor audit must follow prose audit and precede stable core")
            ...
            for section in humor_sections:
                if section not in humor:
                    errors.append(f"references/style-profile.md: humor audit missing section '{section}'")
            humor_dimensions = [
            ...
            for dimension in humor_dimensions:
                ...
                if not score_match or not 0 <= float(score_match.group(1)) <= 10:
                    errors.append(f"references/style-profile.md: invalid humor audit score for '{dimension}'")
